...
file.copy("data/plant_phylogeny/itol/templates/itol_leaf_template.txt",
          "data/plant_phylogeny/itol/itol_rules/itol_leaf_color.txt",
          overwrite = T)
itol_leaves <- paste0(test$label,",",1,collapse = "\n")
write(itol_leaves,file="data/plant_phylogeny/itol/itol_rules/itol_leaf_color.txt",append=TRUE)
```
