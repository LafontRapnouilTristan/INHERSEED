...
# The first time we want to dispatch them according to date of sampling
...
```{r}
image_info <- exiftoolr::exif_read(paste0("data/raw_inputs/P1/leaves_pictures/allpics/",path,tags = c("ExifToolVersion","XResolution","YResolution","ResolutionUnit","ImageSize","Megapixels","CreateDate","FileName","SourceFile")))
```
