...
We aimed to obtain seeds from 8 to 12 plants (depending on the species size) for each species. Of the 65 sowed species, 60 were brought to flowering (loss due to Oïdium). An initial total of 744 plants.
Measurements and samples were performed on all plants but DNA extraction were only performed on a subset of 5 plants per species.
...
data_phenotype |>
  ...
  filter(!variable%in%c(paste0("nb_seeds_fruit_",1:5),"mass_seeds_tot","mass_100_seeds"))|>
